let DefaultFrappeCharts = require('../defaults/frappeCharts')

const mootools = require("mootools")

let debug = require('debug')('mngr-ui-admin-charts:os:cpus.frappeCharts'),
    debug_internals = require('debug')('mngr-ui-admin-charts:os:cpus.frappeCharts:Internals');
