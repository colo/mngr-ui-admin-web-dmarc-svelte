let DefaultVueBars = require('../defaults/vueBars')

const mootools = require("mootools")

let debug = require('debug')('mngr-ui-admin-charts:os:cpus.vueBars.derived.tabular'),
    debug_internals = require('debug')('mngr-ui-admin-charts:os:cpus.vueBars.derived.tabular:Internals');

debug.log = console.log.bind(console)
debug_internals.log = console.log.bind(console)

module.exports = Object.merge(Object.clone(DefaultVueBars),{
  prev: [],
  watch: {
    // merge: true,
    // cumulative: true,
