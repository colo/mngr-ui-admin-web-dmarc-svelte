let DefaultVueEasyPieChart = require('../defaults/vueEasyPieChart')

const mootools = require("mootools")

let debug = require('debug')('mngr-ui-admin-charts:os:cpus.vueEasyPieChart.derived.tabular'),
    debug_internals = require('debug')('mngr-ui-admin-charts:os:cpus.vueEasyPieChart.derived.tabular:Internals');

debug.log = console.log.bind(console)
debug_internals.log = console.log.bind(console)

module.exports = Object.merge(Object.clone(DefaultVueEasyPieChart),{
  prev: [],
  watch: {
    // merge: true,
    // cumulative: true,
