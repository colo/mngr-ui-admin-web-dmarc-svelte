let debug = require('debug')('mngr-ui-admin-charts:defaults:amcharts4'),
    debug_internals = require('debug')('mngr-ui-admin-charts:defaults:amcharts4:Internals');

debug.log = console.log.bind(console)
debug_internals.log = console.log.bind(console)

module.exports = {
  // component: 'amcharts4-wrapper',
